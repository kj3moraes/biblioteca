...
const buttonVariants = {
  initial: {
    gap: 0,
    paddingLeft: '.25rem', // Reduced from .375rem for smaller screens
    paddingRight: '.25rem',
  },
  animate: (isSelected: boolean) => ({
    gap: isSelected ? '.5rem' : 0,
    paddingLeft: isSelected ? '.75rem' : '.5rem', // Reduced padding when selected
    ...
    >
      {tabs.map((tab, index) => {
        ...
        return (
          ...
          >
            <Icon size={20} /> {/* Responsive icon size */}
